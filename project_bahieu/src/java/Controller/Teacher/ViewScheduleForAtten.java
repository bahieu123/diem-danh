...
public class ViewScheduleForAtten extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ViewScheduleForAtten</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ViewScheduleForAtten at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    } 
    ...
    throws ServletException, IOException {
       ScheduleDB scheDB = new ScheduleDB();
        ...
        request.getRequestDispatcher("teacher/ScheduleforAttendance.jsp").forward(request, response);
    } 
